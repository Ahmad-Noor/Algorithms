...
namespace Depth_First_Search_using_List
{
    class Program
    { 
        //k Depth First Search using List.
        //k Depth First Search using List.
        //Depth-first search(DFS) is an algorithm for traversing or searching tree or graph 
        //data structures.One starts at the root (selecting some arbitrary node as the root in the case of a graph)
